...
const invoiceDraftSchema = new mongoose.Schema(
  {
   ...
   bankDetailId: { type: mongoose.Schema.Types.ObjectId, ref: "Bank" },
    ...
    createdBy: { type: mongoose.Schema.Types.ObjectId, ref: "Registration", required: true, }, // Vendor/User
  },
  { timestamps: true }
);

const InvoiceDraft = mongoose.model("InvoicesDraft", invoiceDraftSchema);
